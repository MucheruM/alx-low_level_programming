...
Repo:
OBOBOB
OBOBOBGitHub repository: alx-low_level_programming
Directory: 0x07-pointers_arrays_strings
File: 4-strpbrk.c
...
OBOBOBReturns a pointer to the beginning of the located substring, or NULL if the substring is not found.
OBOBOBFYI: The standard library provides a similar function: strstr. Run man strstr to learn more.
OBOBOB
OBOBOBjulien@ubuntu:~/0x07$ cat 5-main.c
...
{
OAOAOA    char *s = "hello, world";
OAOAOA    char *f = "world";
    char *t;
OAOAOA
OAOAOA    t = _strstr(s, f);
    printf("%s\n", t);
    return (0);
}
...
OAOAOAGitHub repository: alx-low_level_programming
OAOAOADirectory: 0x07-pointers_arrays_strings
OAOAOAFile: 5-strstr.c
OAOAOA  
