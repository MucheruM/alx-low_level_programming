...
OAOAOA#include <stdio.h>
#include <stdlib.h>
OAOAOA
/**
OAOAOA * main - check the code for ALX School students.
 *
 * Return: Always 0.
 */
int main(void)
...
OAOAOANote that we will compile with your alloc_grid.c file. Make sure it compiles.
OAOAOAOAOAOAjulien@ubuntu:~/0x0a. malloc, free$ cat 4-main.c
OAOAOA#include "main.h"
#include <stdio.h>
 ...
 * main - check the code for ALX School students.
 *
OBOBOB * Return: Always 0.
OBOBOB */
int main(void)
OBOBOB{
OBOBOB    int **grid;

OBOBOB    grid = alloc_grid(6, 4);
    if (grid == NULL)
    {
        return (1);
    }
...
OBOBOBjulien@ubuntu:~/0x0a. malloc, free$ gcc -Wall -pedantic -Werror -Wextra -std=gnu89 4-main.c 3-alloc_grid.c 4-free_grid.c -o f
OBOBOBjulien@ubuntu:~/0x0a. malloc, free$ valgrind ./f
...
OBOBOB==5013==   total heap usage: 6 allocs, 6 frees, 1,248 bytes allocated
==5013== 
